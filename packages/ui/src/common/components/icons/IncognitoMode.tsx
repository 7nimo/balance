  ...
  return (
    ...
    >
      ...
      <g transform="scale(.5)">
        ...
        />
        <circle cx={14} cy={34} r={8} fill="var(--icon-accent)" />
        <circle cx={14} cy={34} r={5} fill="var(--icon-main)" />
        <circle cx={34} cy={34} r={8} fill="var(--icon-accent)" transform="rotate(90 34 34)" />
        <circle cx={34} cy={34} r={5} fill="var(--icon-main)" transform="rotate(90 34 34)" />
        <path
          fill="var(--icon-accent)"
          fillRule="evenodd"
